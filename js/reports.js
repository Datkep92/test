...
export function initReports() {
  ...
  document.getElementById('daily-report').addEventListener('click', () => {
    ...
    if (!dateInput) {
      document.getElementById('reportErrorContainer').innerHTML = '<div class="error-message">Vui lòng chọn ngày</div>';
      return;
    }
  ...
  document.getElementById('monthly-report').addEventListener('click', () => {
    const dateInput = document.getElementById('reportDate').value;
    if (!dateInput) {
      document.getElementById('reportErrorContainer').innerHTML = '<div class="error-message">Vui lòng chọn ngày trong tháng</div>';
      return;
    }
