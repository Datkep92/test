...
import { collection, addDoc, onSnapshot, query, orderBy, Timestamp } from 'https://www.gstatic.com/firebasejs/9.22.0/firebase-firestore.js';
...
export function initExpenses() {
  ...
  document.getElementById('add-expense').addEventListener('click', async () => {
    ...
    const errorContainer = document.getElementById('expenseErrorContainer');
    if (!input) {
